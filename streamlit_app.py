...
# Page setup and header configuration
st.set_page_config(
        ...
        with st.spinner("Analyzing regulatory documentation..."):
            try:
                response = requests.post(
                    ...
                    timeout=60  # Extended timeout to accommodate API retries
                )
                ...
                st.error("The request timed out while waiting for the model response. Please try again.")
